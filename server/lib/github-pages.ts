        ...
        <div class="file-body" id="file-body-${idx}" style="display:none">
          ...
          <div class="diff-section">
            <div class="diff-grid">
              ...
              <div class="diff-pane">
                <div class="diff-label optimized-label">KvX Optimized</div>
...
<title>KvX Report - ${escapeHtml(repo.owner)}/${escapeHtml(repo.name)}</title>
<meta name="description" content="Code intelligence report for ${escapeHtml(repo.owner)}/${escapeHtml(repo.name)} generated by KvX">
<meta name="generator" content="KvX Code Intelligence Platform">
<style>
...
<footer>
  <div class="container">
    <p>&copy; ${new Date().getFullYear()} KvX Code Intelligence Platform. Report generated for ${escapeHtml(repo.owner)}/${escapeHtml(repo.name)}.</p>
  </div>
</footer>
