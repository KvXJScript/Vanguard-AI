    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-1/4 w-[500px] h-[500px] bg-primary/8 rounded-full blur-3xl" />
          <div className="absolute bottom-10 right-1/4 w-[400px] h-[400px] bg-primary/5 rounded-full blur-3xl" />
        </div>
      ...
      <section className="py-20 border-t border-border" id="features">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold mb-3" data-testid="text-features-title">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f) => (
              <Card key={f.title} className="hover-elevate transition-all duration-200">
      ...
      <section className="py-20 border-t border-border bg-card/30" id="how-it-works">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold mb-3" data-testid="text-how-title">
              How it works
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
      ...
      <section className="py-20 border-t border-border">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="bg-primary/5 border border-primary/10 rounded-xl p-10">
